...
import { ChevronLeft, ChevronRight, Calendar, Clock, Moon, Users, Download } from 'lucide-react'
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Color-coded schedule view for all employees
            </p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
          ...
          <div className="flex flex-wrap gap-3">
             {/* Simple Legend for now matching the old one */}
             <div className="flex items-center gap-2">
        ...
        {loading && (
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8">
            <div className="flex items-center justify-center">
              ...
              <span className="ml-2 text-gray-600 dark:text-gray-400">Loading employee schedules...</span>
            </div>
          </div>
        )}
