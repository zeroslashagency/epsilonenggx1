...
export const roleSchema = z.enum(['Super Admin', 'Admin', 'Operator', 'Monitor', 'Attendance'], {
...
export const createUserSchema = z
  .object({
    ...
    customPermissions: z.union([z.array(z.string()), z.record(z.any())]).optional(),
  })
  .passthrough()
...
export const searchSchema = z.string().max(255, 'Search query too long').trim().optional()
...
const roleInputSchema = z.preprocess(
