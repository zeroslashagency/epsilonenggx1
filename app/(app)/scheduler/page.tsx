...
import { PartNumberService, PartNumber, samplePartNumbers } from "@/app/lib/features/scheduling/part-number-service"
                            ...
                            <div className="space-y-1">
                              {filteredOperations.map((operation: string, index: number) => {
                                ...
                                return (
                                  <div
                                    key={`${operation}-${index}`}
                                    className={`px-3 py-2 cursor-pointer rounded transition-colors ${isSelected
                                        ? 'bg-gray-200'
                                        : 'hover:bg-gray-100'
                                      }`}
                                    onClick={(e) => {
