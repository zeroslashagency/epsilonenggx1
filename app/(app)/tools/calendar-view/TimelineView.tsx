...
export function TimelineView({ employees, currentDate, onDateChange, isLoading }: TimelineViewProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent overflow-hidden">
      {/* Header Controls */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 z-20">
      ...
      >
        <div className="min-w-max flex flex-col">
          ...
          {/* 1. Header Row (Sticky Top) */}
          <div className="flex sticky top-0 z-[5] bg-gray-900 border-b border-gray-800 h-14 shadow-sm">
            {/* Top-Left Corner (Sticky Left + Top) */}
            <div
              className="sticky left-0 z-[10] w-64 bg-gray-900 border-r border-gray-800 flex items-center px-4 font-semibold text-gray-400 text-sm shadow-[4px_0_24px_rgba(0,0,0,0.5)]"
