...
import { ZohoCard, ZohoBadge, ZohoButton } from '@/app/components/zoho-ui'
import {
  BarChart3,
  Activity,
  TrendingUp,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold text-[#12263F] dark:text-white">
            Charts
          </h1>
          ...
          <ZohoCard>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-[#12263F] dark:text-white">
                    Production Timeline
                  </h3>
                  <p className="text-xs sm:text-sm text-[#95AAC9]">
                    Real-time machine scheduling & task management
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2 bg-[#F8F9FC] dark:bg-gray-800 rounded-lg p-1">
                    ...
                    />
                    <span className="text-sm font-medium min-w-[60px] text-center text-[#12263F] dark:text-white">
                      100%
                    </span>
                    <ZohoButton
                      variant="ghost"
                ...
                <div className="w-52 bg-[#F8F9FC] dark:bg-gray-800 border-r border-[#E3E6F0] dark:border-gray-700">
                  ...
                  <div className="h-14 bg-gradient-to-r from-[#F1F3F4] to-[#F8F9FC] dark:from-gray-700 dark:to-gray-800 border-b border-[#E3E6F0] dark:border-gray-700 flex items-center justify-center">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-sm text-[#12263F] dark:text-white">
                        Machines
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="divide-y divide-[#E3E6F0]">
                    {Array.from({ length: 10 }, (_, index) => {
                      ...
                      return (
                        <div
                          key={machineName}
                          className="h-18 p-4 flex items-center justify-between bg-white dark:bg-gray-900 hover:bg-[#F8F9FC] dark:hover:bg-gray-800 transition-all duration-200 border-l-4 border-transparent hover:border-l-[#2C7BE5]"
                        >
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-3 h-3 rounded-full shadow-sm ${
                                isActive
                                  ? 'bg-[#28A745] shadow-green-200'
                                  : 'bg-[#DC3545] shadow-red-200'
                              }`}
                            ></div>
                            <div>
                ...
                >
                  ...
                  <div className="h-14 bg-gradient-to-r from-[#F1F3F4] to-[#F8F9FC] dark:from-gray-700 dark:to-gray-800 border-b border-[#E3E6F0] dark:border-gray-700 sticky top-0 z-10">
                    <div className="relative h-full flex" style={{ width: '7200px' }}>
                      ...
                      {Array.from({ length: 72 }, (_, i) => {
                        ...
                        const isToday =
                          timelineView === 'day' && date.toDateString() === today.toDateString()
                        const isCurrentHour =
                          timelineView === 'hour' &&
                        ...
                        return (
                          <div
                            ...
                            className={`w-24 border-r border-[#E3E6F0] dark:border-gray-600 flex flex-col items-center justify-center text-xs font-medium transition-colors ${
                              isCurrent
                                ? 'bg-[#2C7BE5]/10 text-[#2C7BE5] font-bold border-[#2C7BE5]/30'
                                : 'text-[#95AAC9] hover:bg-[#F8F9FC] dark:hover:bg-gray-700'
                            }`}
                          >
                            <span>{label}</span>
                            {isCurrent && (
                              <div className="w-1 h-1 bg-[#2C7BE5] rounded-full mt-1"></div>
                            )}
                          </div>
                        )
                      })}
                  ...
                  <div className="relative" style={{ width: '7200px' }}>
                    ...
                    <div
                      ...
                      style={{
                        left: `${timelineView === 'hour' ? 24 * 100 : 30 * 100}px`,
                        height: '720px',
                      }}
                    />
        ...
        <div className="space-y-6">
          <ZohoCard>
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-[#12263F] dark:text-white mb-2">
                Gantt Chart
              </h3>
              <p className="text-[#95AAC9] mb-4">
                Project timeline and task dependencies visualization
              </p>
              <ZohoButton variant="primary">Load Gantt Chart</ZohoButton>
            </div>
          </ZohoCard>
        </div>
      )}
            ...
            <ZohoCard>
              ...
              <div className="h-64 flex items-center justify-center bg-[#F8F9FC] dark:bg-gray-800 rounded">
                <div className="text-center">
                  ...
                  <p className="text-xs text-[#95AAC9]">
                    Line chart component would be integrated here
                  </p>
                </div>
              </div>
            </ZohoCard>
