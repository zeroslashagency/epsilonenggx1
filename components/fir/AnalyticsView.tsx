...
export function AnalyticsView({ reports }: AnalyticsViewProps) {
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-gray-900 p-6 md:p-10">
            <div className="max-w-7xl mx-auto space-y-8">

                {/* Header */}
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Analytics Dashboard</h1>
                    <p className="text-slate-500 dark:text-gray-400">Insights into performance, trends, and report distribution.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-slate-500 dark:text-gray-400 font-medium text-sm">Total Reports</span>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-slate-500 dark:text-gray-400 font-medium text-sm">Positive Rate</span>
                        ...
                        <div className="text-xs text-slate-400 dark:text-gray-500 mt-1">of total reports</div>
                    </div>

                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-slate-500 dark:text-gray-400 font-medium text-sm">Positive Reports</span>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-slate-500 dark:text-gray-400 font-medium text-sm">Negative Reports</span>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={trendData}>
                                    ...
                                    <Tooltip
                                        ...
                                        contentStyle={{ background: '#1e293b', borderRadius: '8px', border: '1px solid #334155', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
