  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-[var(--sidebar-width)] bg-transparent transition-[width] duration-400 ease-[cubic-bezier(0.7,-0.15,0.25,1.15)]',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-50 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width] duration-400 ease-[cubic-bezier(0.75,0,0.25,1)] md:flex',
          side === 'left'
